...
export const TempAverage = () => {
    ...
    const getTempDataAPI = async() => {
        try{
            const {data:data} = await fetch('http://3.35.57.189:8080/Home-Sensor/temperature/get-data').then(res=>res.json());
